        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding">
              ...
              <p></p>
              <input type="text"name="Start_date" placeholder="Start_date" required="required" id="Start_date">
              <input type="text"name="End_date" placeholder="End_date" required="required" id="End_date">
              <p></p>
              <input type="text"name="Manager_ID" placeholder="Manager_ID" required="required" id="Manager_ID">
              <p></p>
              <!-- <input type="text"name="Front_end_staff" placeholder="Front_end_staff" required="required" id="Front_end_staff">
             -->
             <label style="margin-right:10px">Front_end_staff:</label><select id="Front_end_worker" name="Front_end_worker">
              ...
              <p></p>
              <label style="margin-right:15px">Back_end_staff:</label><select id="Back_end_staff" name="Back_end_staff">
                <option value="None"> </option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
              ...
              <label style="margin-right:31px">Testing_staff:</label><select id="Testing_staff" name="Testing_staff">
                <option value="None"> </option>
                <option value="1">1</option>
                <option value="2">2</option>
                <option value="3">3</option>
