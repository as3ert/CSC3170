  ...
  <div class="w3-row">
    ...
    <?php
            foreach($projectList as $k => $project){
              ...
              echo "<h6 class='w3-text-teal'><i class='fa fa-calendar fa-fw w3-margin-right'></i>Jun 2023 - Jun 2024</h6>";
...
<footer class="w3-container w3-theme-d5">
  <p>Powered by <a href="https://github.com/as3ert/csc3170" target="_blank">Team X</a></p>
</footer>
